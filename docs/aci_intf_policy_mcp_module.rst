...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>The description for the MCP interface.</div>
    ...
    <tr>
    <td>mcp<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
    <td></td>
    <td>
        <div>The name of the MCP interface.</div>
        </br><div style="font-size: small;">aliases: mcp_interface, name</div>
    </td>
    </tr>
