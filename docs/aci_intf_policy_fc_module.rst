...
* More information from the internal APIC class *fc:IfPol* at https://developer.cisco.com/media/mim-ref/MO-fcIfPol.html.
...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>The description of the Fiber Channel interface policy.</div>
        </br><div style="font-size: small;">aliases: descr</div>
    </td>
    </tr>

    <tr>
    <td>fc_policy<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
    <td></td>
    <td>
        <div>The name of the Fiber Channel interface policy.</div>
    ...
    <tr>
    <td>port_mode<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>f</td>
