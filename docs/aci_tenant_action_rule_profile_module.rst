...
.. raw:: html
    ...
    <tr>
    <td>action_rule<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
    <td></td>
    <td>
        <div>The name of the action rule profile.</div>
        </br><div style="font-size: small;">aliases: action_rule_name, name</div>
    </td>
    </tr>
    ...
    <td></td>
    <td>
        <div>The description for the action rule profile.</div>
