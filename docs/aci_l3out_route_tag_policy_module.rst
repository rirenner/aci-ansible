...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>The description for the route tag policy.</div>
    ...
    <tr>
    <td>rtp<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
    <td></td>
    <td>
        <div>The name of the route tag policy.</div>
        </br><div style="font-size: small;">aliases: name, rtp_name</div>
    </td>
    </tr>
    ...
    <td></td>
    <td>
        <div>The value of the route tag (range 0-4294967295).</div>
    </td>
    </tr>
