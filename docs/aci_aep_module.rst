...
.. raw:: html
    ...
    <tr>
    <td>aep<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
    <td></td>
    <td>
        <div>The name of the Attachable Access Entity Profile.</div>
        </br><div style="font-size: small;">aliases: aep_name, name</div>
    </td>
    </tr>
    ...
    <td></td>
    <td>
        <div>Description for the AEP.</div>
    </td>
    </tr>
